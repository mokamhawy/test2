...
use Rack::Session::EncryptedCookie,
  :secret => 'Stna#showy@ya&mhaj*8900328018r632786r' # Actually use something secret here!
  ...
  if session.has_key?(:customer_id)
    ...
    if default_customer_id
      ...
      begin
        ...
        ['4000000000003220', '4000000000003063', '4000000000003238', '4000000000003246', '4000000000003253', '4242424242424242', '4242424242425555'].each { |cc_number|
